            ...
            <div class="sheet-body">
                <div class="header">
                    ...
                    <div class="logo">
                     ...
                     <BR><h2 id="slogan-text" class="logo-text"> Examen Implantacion Aplicaciones Web  1ª Evaluacion(2020/2021)</h2>
                    </div>
                </div>
                <div class="nav">
                	<div class="l"></div>
                	...
                	<ul class="menu">
                		...
                		<li>
                			<a href="borrar.php"><span class="l"></span><span class="r"></span><span class="t">Borrar Incidencia</span></a>
                			
                		</li>
                                <li>
                			<a href="listar.php"><span class="l"></span><span class="r"></span><span class="t">Listar Incidencia</span></a>
